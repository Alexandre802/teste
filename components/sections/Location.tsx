            ...
            <div className="glass flex h-full flex-col gap-6 rounded-[var(--radius-card)] p-7 sm:p-9">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <address className="mt-1.5 not-italic leading-relaxed text-cream/90">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="mt-1.5 block text-lg font-bold text-cream hover:text-gold"
                  >
              ...
              <div>
                ...
                <ul className="mt-3 flex flex-wrap gap-2">
                  {business.services.map((service) => (
                    <li
                      key={service}
                      className="rounded-full bg-ink-3 px-4 py-2 text-sm font-semibold text-cream/85 ring-1 ring-inset ring-flame/25"
                    >
                      {service}
                    </li>
                  ))}
              ...
              <div className="mt-auto flex flex-col gap-3 pt-2 sm:flex-row">
                <a
                  ...
                  className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-cream px-6 py-3.5 font-extrabold text-ink transition-transform hover:-translate-y-0.5"
                >
                  <PinIcon className="h-5 w-5" />
                  Como chegar
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex flex-1 items-center justify-center gap-2 rounded-full border border-cream/40 px-6 py-3.5 font-extrabold text-cream transition-all hover:-translate-y-0.5 hover:border-gold hover:text-gold"
                >
          ...
          <Reveal delay={0.1}>
            <div className="glass h-full min-h-[22rem] overflow-hidden rounded-[var(--radius-card)] p-1.5">
              <iframe
                ...
                className="h-full min-h-[21rem] w-full rounded-[1.3rem] grayscale-[0.35] contrast-[1.1]"
              />
            </div>
          </Reveal>
        </div>
