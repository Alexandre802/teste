...
export interface BurgerLayer {
  ...
  top: number;
  height: number;
  /** deslocamento para o estado montado, em pixels da foto original */
  shift: number;
}

export const BURGER_LAYERS: BurgerLayer[] = [
  { src: '/lanche/1-pao-superior.webp', alt: 'Pão superior', top: 0, height: 186, shift: 0 },
  { src: '/lanche/2-tomate.webp', alt: 'Tomate', top: 186, height: 156, shift: -36 },
  { src: '/lanche/3-alface.webp', alt: 'Alface', top: 342, height: 134, shift: -130 },
  { src: '/lanche/4-queijo-cima.webp', alt: 'Queijo', top: 476, height: 144, shift: -194 },
  { src: '/lanche/5-carne-cima.webp', alt: 'Carne', top: 620, height: 150, shift: -260 },
  { src: '/lanche/6-queijo-baixo.webp', alt: 'Queijo', top: 770, height: 114, shift: -305 },
  { src: '/lanche/7-carne-baixo.webp', alt: 'Carne', top: 884, height: 164, shift: -359 },
  { src: '/lanche/8-pao-inferior.webp', alt: 'Pão inferior', top: 1048, height: 136, shift: -418 },
];
