---
name: remotion
description: Rules for writing Remotion video code in React — compositions, frame-driven animation with useCurrentFrame/interpolate/spring, timing with Sequence/Series/TransitionSeries, media tags (OffthreadVideo, Img, Gif, Audio), staticFile assets, and deterministic rendering. Use whenever creating or editing a video composition, scene, or animation in this repo, or when a change must render identically frame-by-frame.
---
